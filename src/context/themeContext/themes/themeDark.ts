  ...
  modules: {
    ...
    breadCrumbMenuItem: {
      colors: {
        bg: {
          ...
          hover: { normal: tertiaryBg, active: "#496954" }
        }
      }
    },
    ...
    sidebarLeft: {
      ...
      profileNew: {
        colors: {
          border: "#42464e",
          font: { normal: "#cdcdcd", hover: primaryFont },
          bg: { normal: "#32363f", hover: tertiaryBg },
          icon: { normal: "#7d7f85", hover: primaryFont }
        }
      },
