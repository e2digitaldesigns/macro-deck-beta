...
export const allActionMap: IntAllActionMap = {
  ...
  mcAudioPrev: "Previous Song",
  mcAudioStop: "Stop Song",
  mcAudioPause: "Pause Song",
  mcAudioPlay: "Play Song",

  mcAudioNext: "Next Song",
  mcAudioMute: "Mute",
  mcAudioVolumeDown: "Volume Down",
  mcAudioVolumeUp: "Volume Up",
